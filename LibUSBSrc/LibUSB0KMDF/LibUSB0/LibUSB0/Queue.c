...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, LibUSB0QueueInitialize)
#endif

NTSTATUS
LibUSB0QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = LibUSB0EvtIoDeviceControl;
    queueConfig.EvtIoStop = LibUSB0EvtIoStop;
